                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>{{ $category->slug }}</td>
                                    <td>
                                        <button class="btn btn-primary btn-sm category-edit" data-id="{{ $category->id }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"><i class="fa fa-pencil-alt"></i></button>
                                        <button class="btn btn-danger btn-sm category-delete" data-id="{{ $category->id }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
